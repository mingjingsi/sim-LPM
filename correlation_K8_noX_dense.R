...
##### when annotations have no role (eight traits, dense graph)      #####
...
# results to get Supplementary Figure S6b
...
# result to get Supplementary Figure S6c
plot(est_GGPA[[1]]) 
plot(est_GGPA[[2]])
